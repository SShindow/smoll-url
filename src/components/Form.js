  ...
  validateInput = async () => {
    ...
    if (this.state.preferedAlias !== '') {
      if (this.state.preferedAlias.length > 10) {
        ...
        errorMessages['suggestedAlias'] = 'Please Enter an Alias less than 10 Characters';
    ...
    return (
      <div className="container">
        <form autoComplete="off">
          ...
          <div className="form-group">
            <label htmlFor="basic-url">Your Smoll URL</label>
            <div className="input-group mb-3">
              <div className="input-group-prepend">
                <span className="input-group-text">smollurl.com/</span>
              </div>
              <input
                id="preferedAlias"
                onChange={this.handleChange}
                ...
                type="text" placeholder="e.g. urmomhot (Optional)"
              />
            </div>
            <div
              className={
